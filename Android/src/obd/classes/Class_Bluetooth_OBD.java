...
public class Class_Bluetooth_OBD extends Class_Bluetooth {
	...
	private boolean wait_for_alert = false;
	private boolean quitter = false;
	private boolean relancerTest = false;
	private File fileOBD = null;
    ...
    public Class_Bluetooth_OBD (String nomBT, Context context, Handler toMainFrame, String receivedSplit)	{
    		super(nomBT, enum_typeBluetooth.OBD, context, toMainFrame, receivedSplit);// hstatus, h, context);
